...
export function SlideIn({ children, delay = 0, className = '' }: AnimatedContainerProps) {
  return (
    <motion.div
...
export function DrawerSlide({ children, isOpen }: { children: ReactNode; isOpen: boolean }) {
  return (
    <AnimatePresence>
      {isOpen && (
        <>
